package md.master.repository;

import md.master.VreuMesterApp;
import md.master.config.Constants;
import md.master.config.audit.AuditEventConverter;
import md.master.domain.PersistentAuditEvent;
...
import static md.master.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
