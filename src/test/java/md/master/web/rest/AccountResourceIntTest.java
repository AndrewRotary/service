package md.master.web.rest;

import md.master.config.Constants;
import md.master.VreuMesterApp;
import md.master.domain.Authority;
import md.master.domain.User;
import md.master.repository.AuthorityRepository;
import md.master.repository.UserRepository;
import md.master.security.AuthoritiesConstants;
import md.master.service.MailService;
import md.master.service.dto.UserDTO;
import md.master.service.dto.PasswordChangeDTO;
import md.master.web.rest.errors.ExceptionTranslator;
import md.master.web.rest.vm.KeyAndPasswordVM;
import md.master.web.rest.vm.ManagedUserVM;
import md.master.service.UserService;
...
@SpringBootTest(classes = VreuMesterApp.class)
